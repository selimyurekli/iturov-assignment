...
(cl:defmethod cl:initialize-instance :after ((m <bottom>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'bottom)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<bottom> is deprecated: use beginner_tutorials-msg:bottom instead.")))

(cl:ensure-generic-function 'dec_16-val :lambda-list '(m))
(cl:defmethod dec_16-val ((m <bottom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:dec_16-val is deprecated.  Use beginner_tutorials-msg:dec_16 instead.")
  (dec_16 m))
