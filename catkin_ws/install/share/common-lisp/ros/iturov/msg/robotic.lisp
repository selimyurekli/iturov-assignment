...
(cl:defmethod cl:initialize-instance :after ((m <robotic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iturov-msg:<robotic> is deprecated: use iturov-msg:robotic instead.")))

(cl:ensure-generic-function 'dec_24-val :lambda-list '(m))
(cl:defmethod dec_24-val ((m <robotic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iturov-msg:dec_24-val is deprecated.  Use iturov-msg:dec_24 instead.")
  (dec_24 m))
